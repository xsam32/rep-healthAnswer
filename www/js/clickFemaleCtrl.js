myControllers.controller('clickFemaleCtrl', function($scope, $ionicLoading) {
    startDB();
    $scope.playlists = [];
    ///////////  Retrieve All Task ////////////////
    retrieveAllTask();
    ...
    function getEmployees(tx) {
        var sql2 = "select SymptomCat, SymptomThai, SymptomEng, sex from Symptom where sex <> 'm' order by SUBSTR(SymptomThai,case when SUBSTR(SymptomThai,1,1) in ('เ','แ','ไ','ใ','โ') then 2 else 1 end,1),SymptomThai";
